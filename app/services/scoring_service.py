...
from app.models import ProductVersion, SquorScore, SquorComponent
...
class ScoringService:
    ...
    async def calculate_squor(self, product_version_id: UUID) -> Dict[str, Any]:
        ...
        verification_score = await self._calculate_verification_score(
            ingredients, nutrition, certifications
        )
    ...
    async def _calculate_health_score(
        ...
        if ingredients and ingredients.get("normalized_list"):
            ...
            bad_ingredients = [
                "palm oil", "hydrogenated", "trans fat", "high fructose",
                "artificial color", "artificial flavour", "msg"
            ]
